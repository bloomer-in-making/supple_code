...
#######################################################################
    def get_prompt_encoder(self, batch_size, task_ids, raw_embeds):
        
        batch_prompts = self.prompter.generate(raw_embeds)
        if self.config.method != 'residual_emb':
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            prompts_encoder = self.get_prompt_encoder(batch_size=batch_size, task_ids=task_ids, raw_embeds=raw_embeds)
